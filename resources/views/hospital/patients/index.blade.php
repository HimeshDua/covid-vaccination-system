                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="{{ route('hospital.appointments.index', ['patient_id' => $patient->id]) }}"
    ...
    <div class="modal fade" id="filterModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('hospital.patients.index') }}" method="GET">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('hospital.patients.index') }}" class="btn btn-secondary">Clear Filters</a>
